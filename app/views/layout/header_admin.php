    ...
    <header class="header">
        <nav class="navbar">
            <ul class="navbar__menu">
                ...
                <li><a href="#" class="navbar__link">Gestión Usuarios</a></li>
                <li><a href="#" class="navbar__link">Gestión Tablas Maestras</a></li>
                <li><a href="?controller=contact&action=mostrarMisConsultas" class="navbar__link">Consultas Generadas</a></li>
